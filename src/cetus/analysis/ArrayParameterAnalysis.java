...
//System.out.println("+++++++++++++pointer arithmetic add++++++++++++++");
                ret = new UnaryExpression(UnaryOperator.ADDRESS_OF,
                        new ArrayAccess(lhs.clone(), rhs.clone()));

//System.out.println("++++++++++new constructed unary expression:"+ret+"++++++++++++");
    ...
    */
    private Expression
        ...
        Symbol arg_symbol = SymbolTools.getSymbolOf(arg);
//System.out.println("++++++++++++++++process expression symbol"+arg_symbol+"+++++++++++++++");
        if (IRTools.containsClasses(arg, avoided_arg_child) ||
            !(arg instanceof Identifier || arg instanceof UnaryExpression || arg instanceof ArrayAccess) ||
                arg_symbol == null ||
                arg_symbol instanceof Procedure ||
                arg_symbol instanceof ProcedureDeclarator ||
                arg_symbol.getArraySpecifiers().isEmpty()) {
            
//System.out.println("++++++++++++++++unable to analyze+++++++++++++++"); // unable to analyze this case.
