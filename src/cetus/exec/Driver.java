...
//        }
        ...
        if(getOptionValue("loop")!=null) {
            AnalysisPass.run(new LoopAnalysisPass(program));
        }
        // if(getOptionValue("ipchain")!=null)
        //     AnalysisPass.run(new IPChainAnalysis(program));        
        
        // if(getOptionValue("range")!=null) {
        //         AnalysisPass.run(new RangeAnalysis(program));
        // }

        // AnalysisPass.run(new ArrayParameterAnalysis(program));
